...
"""
    All parameters are read from config file.
    /etc/observ.conf
"""
...
from observ.exceptions import ObservEmailUnableRelay
...
class Email:
    ...
    def send(self, destination, mail_from, subject, msg):
        """
            :param: destination: To mail address, str
            :param: mail_from: Mail sending from, str
            :param: subject: Mail Subject, str
            :param: msg: Mail Message, str
        """
        msg = MIMEText(msg)
